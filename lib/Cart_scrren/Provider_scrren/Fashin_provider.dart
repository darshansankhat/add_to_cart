...
class Fashion_provider extends ChangeNotifier
{
  List<Fashion_model> Fashionlist=[
    Fashion_model(img: "assets/image/boy_f/f1.jpg",name: "Hudi",price: 1000,line: "Best For Each"),
